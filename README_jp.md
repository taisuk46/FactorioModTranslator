...
- **対応言語**: 日本語、英語、中国語（簡体字/繁体字）、韓国語、フランス語、ドイツ語、イタリア語、スペイン語、ポルトガル語、ロシア語に対応
- **スマートフォーマット**: Factorio固有のタグ（`__1__`、`[item=...]`など）を保護しながら翻訳を行い、ゲーム内での動作を維持
...
2. [Mod Selection] タブで翻訳したいModのフォルダを選択します。Modのフォルダは、「%APPDATA%\Factorio\mods\[mod folder]」のように、modのzipファイルをあらかじめ解凍しておく。
3. 翻訳実行ボタンをクリックします。
